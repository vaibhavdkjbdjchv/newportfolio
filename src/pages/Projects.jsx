      ...
      <div className="w-[100%] py-10 flex flex-col items-center justify-center gap-5">
        ...
        <ProjectsCards
          ...
          detailsLink=<div className="py-1 mt-20 flex flex-col px-2  justify-between items-start text-white">
            ...
            <p className="mt-2">
              ...
              design, animations for a better user experience, clean and modern
              UI, showcasing services and plans for the internet provider.
            </p>
          </div>
        />
        <ProjectsCards
          ...
          detailsLink=<div className="py-1 gap-2  mt-10 flex flex-col px-2 justify-between items-start text-white">
            ...
            <ul className="list-disc list-inside mt-2">
              <li>
                <span className="font-semibold">Project Type:</span> AI-powered
                chat assistant UI clone
              </li>
              <li>
                <span className="font-semibold">Technology Used:</span>
                <ul className="list-disc list-inside ml-4">
            ...
            <p className="mt-2">
              <span className="font-semibold">Key Features:</span> AI-based chat
              UI, modern responsive design, smooth animations, dark mode
        ...
        <ProjectsCards
          ...
          detailsLink=<div className="py-1 mt-20 flex flex-col px-2  justify-between items-start text-white">
            ...
            <p className="mt-2">
              ...
              Real-time gameplay and seamless multiplayer interaction ♟️ Robust
        ...
        <ProjectsCards
          ...
          detailsLink=<div className="py-2 flex flex-col px-2 justify-between items-start text-white">
            <h1 className="text-lg font-bold">🛒 Shopper E-commerce Website</h1>
            <p>
              <span className="font-semibold">Website Project Type:</span>{" "}
            ...
            <p className="mt-2">
              ...
              authentication, product listings, cart management, secure payment
              gateway, order tracking, and a responsive UI with smooth
              animations.
            </p>
          </div>
        />
        ...
        <ProjectsCards
          ...
          detailsLink=<div className="py-1 flex flex-col px-2  justify-between items-start text-white">
            ...
            <p className="mt-2">
              ...
              authentication, product catalog, shopping cart, order management,
              admin panel for product management, and a responsive design for
              all devices.
            </p>
          </div>
        />
